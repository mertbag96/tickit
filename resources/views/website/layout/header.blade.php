...
<header class="shadow-sm py-6">
    ...
    <nav class="container mx-auto flex justify-between items-center">
        ...
        <ul class="flex items-center space-x-12 text-dark text-lg">
            <li>
                <a href="#" class="transition duration-200 hover:text-primary">
                    Features
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="#" class="px-4 py-2 bg-primary rounded-md text-white transition duration-200 hover:bg-secondary hover:text-dark">
                    Get Started
                </a>
            </li>
        </ul>
